...
const DetailPage = (() => {
    ...
    async function loadMovieDetail() {
        ...
        try {
            ...
            document.title = `${movie.title} - WASUSANOCH`;
                    ...
                    <div class="detail-top">
                        ...
                        <div class="detail-info">
                            ...
                            <div class="detail-actions">
                                <button class="btn btn-primary" onclick="UI.openTrailerModal('https://vidsrc.xyz/embed/movie?tmdb=${movie.id}', true, '${movie.title.replace(/'/g, "\\'")}')">
    ...
    async function loadTVDetailTMDB() {
        ...
        try {
            const show = await API.TMDB.movieDetails(contentId);
            document.title = `${show.name || show.title} - WASUSANOCH`;
                ...
                <div class="detail-main">
                    <div class="detail-top">
                        ...
                        <div class="detail-info">
                            ...
                            <div class="detail-actions">
                                <button class="btn btn-primary" onclick="UI.openTrailerModal('https://vidsrc.xyz/embed/tv?tmdb=${show.id}', true, '${(show.name||show.title).replace(/'/g, "\\'")}')">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><polygon points="5,3 19,12 5,21"/></svg>
                                    Play Show
                                </button>
    ...
    async function loadTVMazeDetail() {
        ...
        try {
            ...
            document.title = `${show.name} - WASUSANOCH`;
                ...
                <div class="detail-main">
                    <div class="detail-top">
                        ...
                        <div class="detail-info">
                            ...
                            <div class="detail-actions">
                                ${show.externals?.imdb ? `
                                <button class="btn btn-primary" onclick="UI.openTrailerModal('https://vidsrc.xyz/embed/tv?imdb=${show.externals.imdb}', true, '${show.name.replace(/'/g, "\\'")}')">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><polygon points="5,3 19,12 5,21"/></svg>
                                    Play Show
                                </button>` : ''}
    ...
    async function loadAnimeDetail() {
        ...
        try {
            ...
            document.title = `${anime.title_english || anime.title} - WASUSANOCH`;
                ...
                <div class="detail-main">
                    <div class="detail-top">
                        ...
                        <div class="detail-info">
                            ...
                            <div class="detail-actions">
                                ${anime.trailer?.youtube_id ? `<button class="btn btn-primary" onclick="UI.openTrailerModal('${anime.trailer.youtube_id}')">
